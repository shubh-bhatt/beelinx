...
const ExploreHero = () => {
  return (
    <>
      {/* Hero Section */}
      <section className="relative overflow-hidden bg-linear-to-br from-sky-600 via-sky-600 to-cyan-500 text-white py-24 px-6">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="hidden lg:flex justify-center">
              <div className="bg-white w-full h-96 rounded-2xl p-2">
                ...
                <img src={ServicesSVG} className="h-full w-full" />
              </div>
            </div>
          </div>
        </div>
